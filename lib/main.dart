  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Phone Call",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
      body: Padding(
          ...
          children: [
            Row(
              ...
              children: const [
                CircleAvatar(
                  radius: 15,
                  backgroundColor: Colors.green,
                  child: Icon(Icons.call_outlined,color: Colors.white,size: 18,)
                ),
                SizedBox(width: 5,),
            ...
            Center(
              child: OutlinedButton(
                ...
                onPressed: ()async {
                  const url = "tel:9999995566";
                  await launch(url);
                }, 
                child: const Text("Phone Call",style: TextStyle(color: Colors.white),)
              ),
            )
          ],
        ),
